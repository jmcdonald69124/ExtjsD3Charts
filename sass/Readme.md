...
folder are mapped to the application's root namespace, 'ExtD3ChartDemo'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtD3ChartDemo"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtD3ChartDemo' in the same way
as `"ExtD3ChartDemo/sass/src"`.
